window.onload = function() {
	...
	document.onkeyup = function(event){
		...
		if (triesCounter !== 0){					
			...
			document.getElementById("alert").innerHTML = "Resistence is futile. You lose.";
			lossesCounter ++;
		...
		if (arrayWd.indexOf(letter) !== -1){
			...
			for (var i=0; i< letterIndexes.length; i++){
				...
				if(dashesArr.indexOf("_") === -1){
					document.getElementById("alert").innerHTML = "Well done, you are a testiment to the Federation."
					winsCounter++;
					document.getElementById("wl").innerHTML = "Wins: " + winsCounter + "	vs.  " + "  Losses: " + lossesCounter;
